...
Estado de desarrollo posterior al release: la versión interna `1.13.0` agrega una capa de dominio pura para calcular vencimientos base y clasificar pólizas, sin cambios visibles en la GUI ni escritura de archivos.
