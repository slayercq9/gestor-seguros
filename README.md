...
Estado de desarrollo posterior al release: la versión interna `1.13.1` conecta la lógica de vencimientos base con una vista inicial de solo lectura en la GUI. La vista no genera avisos, documentos, exportaciones ni modifica archivos Excel.
